...
project = u'HyDe'
copyright = u'2017, Paul Blischak and Laura Kubatko'
author = u'Paul Blischak and Laura Kubatko'
...
latex_documents = [
    (master_doc, 'HyDe.tex', u'HyDe Documentation',
     u'Paul Blischak and Laura Kubatko', 'manual'),
]
